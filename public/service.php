                ...
                <div class="row g-4">
                    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item p-4">
                            ...
                            <p class="mb-0">Simplify your booking with our hassle-free phone reservation service. Our friendly representatives are ready to help you find the perfect vehicle and provide personalized assistance.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item p-4">
                            ...
                            <p class="mb-0">Enjoy unbeatable pricing with our special rates. We offer transparent, budget-friendly options without compromising on quality, ensuring the best value for your rental.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item p-4">
                            ...
                            <p class="mb-0">Travel with ultimate freedom through our one-way rental service. Pick up and drop off your vehicle at different locations, maximizing convenience and flexibility.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item p-4">
                            ...
                            <p class="mb-0">Drive with complete peace of mind through our comprehensive insurance coverage. We protect you throughout your journey, ensuring confidence and security.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item p-4">
                            ...
                            <p class="mb-0">Explore beyond city limits with our seamless city-to-city rental service. Experience the freedom to travel between destinations with ease and unparalleled convenience.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item p-4">
                            ...
                            <p class="mb-0">Enjoy our special welcome offers designed to enhance your rental experience. From complimentary upgrades to bonus miles, we go the extra mile for you.</p>
                        </div>
                    </div>
                </div>
            </div>
