                ...
                <div class="container-fluid">
                    ...
                    <div class="row g-4 mb-4">
                        <div class="col-md-4 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="card stat-card border-0 shadow-sm overflow-hidden">
                                <div class="card-body text-center position-relative">
                                    <div class="bg-primary rounded-circle p-3 d-inline-block mb-3 wow pulse animate__infinite">
                        ...
                        <div class="col-md-4 wow fadeInUp" data-wow-delay="0.7s">
                            <div class="card stat-card border-0 shadow-sm overflow-hidden">
                                <div class="card-body text-center position-relative">
                                    <div class="bg-success rounded-circle p-3 d-inline-block mb-3 wow pulse animate__infinite">
                        ...
                        <div class="col-md-4 wow fadeInUp" data-wow-delay="1s">
                            <div class="card stat-card border-0 shadow-sm overflow-hidden">
                                <div class="card-body text-center position-relative">
                                    <div class="bg-warning rounded-circle p-3 d-inline-block mb-3 wow pulse animate__infinite">
